...
<div id="demo" style="text-align:center; max-width: 500px; margin: auto;">
	...
	<form action="<?php the_permalink(); ?>" method="POST" enctype="multipart/form-data" style='display:inline;'>
		<fieldset>
			<legend>上传身份证正面</legend>
	...
	<form action="<?php the_permalink(); ?>" method="POST" enctype="multipart/form-data" style='display:inline;'>
		<fieldset>
			<legend>上传身份证背面</legend>
			<strong><label for="input_demo3" id="label3">输入身份证号码: </label></strong>
			<!-- <br class="rwd-break" /> -->
			<input type="text" name="ID3" id='input_demo3'>
			<!-- <br class="rwd-break" /> -->
			<br>
